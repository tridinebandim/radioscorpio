...
//error_reporting(0);
define('SERVER', 'http://193.190.253.57:8000');//your icecast server address, without the ending "/"
define('MOUNT', '/stream'); //your radio's mount point, with the leading "/"
define('LAST_FM_API', 'd8fcc78e38421288ff29f6ae54d08c58'); //your last.fm API key, get from http://www.last.fm/api/account
